    ...
    <div className="text-center">
      ...
      <div className="mb-3 sm:mb-4">
        ...
        <div className="space-y-1 sm:space-y-1.5">
          <p className="text-gray-700 text-xs sm:text-sm md:text-base font-sans font-medium">Share this with the other person</p>
          <p className="text-gray-500 text-[11px] sm:text-xs md:text-sm font-sans">Show on screen or read aloud</p>
        </div>
      </div>
      ...
      {isUserVerified && (
        <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-slate-200 bg-gradient-to-r from-green-50 to-emerald-50 -m-4 sm:-m-5 md:-m-6 mt-3 sm:mt-4 p-3 sm:p-4 rounded-b-2xl sm:rounded-b-3xl">
          <div className="flex items-center justify-center gap-1.5 sm:gap-2">
            ...
            <span className="text-green-700 text-xs sm:text-sm md:text-base font-medium font-sans">✓ The other user has verified you</span>
          </div>
        </div>
      )}
    </div>
