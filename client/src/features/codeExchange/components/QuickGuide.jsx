export const QuickGuide = () => (
  <div className="mb-4 sm:mb-5 md:mb-6 rounded-2xl sm:rounded-3xl border border-indigo-100 bg-[linear-gradient(135deg,#faf9ff_0%,#f3f0ff_54%,#f8f7ff_100%)] px-4 sm:px-5 md:px-6 py-3.5 sm:py-4 md:py-5 max-w-sm w-full mx-auto shadow-[0_35px_90px_-70px_rgba(79,70,229,0.6)]">
