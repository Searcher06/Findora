...
export const SearchBar = ({ className, onChange, value = "" }) => {
  return (
    <div className={`w-full ${className}`}>
      <div className="group flex h-12 w-full items-center gap-2 rounded-xl border border-white/50 bg-white/85 px-3 shadow-[0_10px_40px_-25px_rgba(12,74,110,0.65)] backdrop-blur transition focus-within:border-violet-300 focus-within:ring-4 focus-within:ring-violet-100">
        <Search size={18} className="text-slate-400 group-focus-within:text-violet-700" />
        <input
          type="text"
