...
const BrowsePage = () => {
  ...
  return (
    <div
      ref={pageTopRef}
      className="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-50 via-slate-100/60 to-white px-2.5 pb-12 pt-2.5 sm:px-3 md:px-6 md:pt-4 lg:pt-6"
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl">
        <section className="group relative overflow-hidden rounded-3xl border border-indigo-200/80 bg-[linear-gradient(135deg,#f5f3ff_0%,#e9e1ff_40%,#f6f2ff_100%)] px-4 py-6 text-slate-900 shadow-[0_35px_95px_-60px_rgba(67,56,202,0.55)] ring-1 ring-white/60 sm:px-8 sm:py-10">
          ...
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="grid w-full grid-cols-2 gap-2 rounded-2xl border border-indigo-300/60 bg-white/70 p-3 backdrop-blur sm:w-auto sm:min-w-[260px]">
        ...
        <div className="mt-6 flex items-start justify-between gap-3 px-1 sm:items-center">
          <div>
            <h2 className="font-display text-xl font-bold text-indigo-950 sm:text-2xl">
